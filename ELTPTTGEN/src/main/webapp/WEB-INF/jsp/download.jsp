...
<title>Download Time Table</title>
						...
						<div class="col-sm-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h3 class="panel-title">Enter the Batch name</h3>
								</div>
								<div class="panel-body">
									<div class=" form">
										<form:form modelAttribute="batch"
											class="cmxform form-horizontal tasi-form" id="signupForm"
											method="get" action="downloadPDF" novalidate="novalidate">
											...
											<button
												...
												type="submit">Download in Pdf</button>
											<div class="col-md-4"></div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class=" form">
										<form:form modelAttribute="batch"
											class="cmxform form-horizontal tasi-form" id="signupForm"
											method="get" action="downloadExcel" novalidate="novalidate">
											<div class="form-group ">
												<label for="firstname" class="control-label col-lg-2">Batch
													Name</label>
												<div class="col-lg-10">
											...
											<button
												class="col-md-4 btn btn-primary waves-effect waves-light btn-lg m-b-5"
												type="submit">Download in Excel</button>
											<div class="col-md-4"></div>
										</form:form>
									</div>
								</div>
