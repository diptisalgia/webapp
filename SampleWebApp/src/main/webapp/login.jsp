        ...
        <div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                <div class="panel-heading bg-img"> 
                    ...
                    <h3 class="text-center m-t-10 text-white"> <strong>ELTP TimeTable Generator</strong> </h3>
                </div> 


                <div class="panel-body">
                <form class="form-horizontal m-t-20" action=" onlogin">
                    
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control input-lg " type="text" required=""  autofocus="" input placeholder="Username">
                        </div>
                    </div>
