						...
						<div class="col-sm-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h3 class="panel-title">New Batch Details</h3>
								</div>
								<div class="panel-body">
									<div class=" form">
										<form:form modelAttribute="batch"
											class="cmxform form-horizontal tasi-form" id="signupForm"
											method="get" action="add_batch_1" novalidate="novalidate">
											<div class="form-group ">
												<label for="firstname" class="control-label col-lg-2">Batch
													Name</label>
												<div class="col-lg-10">
													<form:input path="batch_name" class=" form-control"
														id="firstname" type="text" />
												</div>
											</div>
											<div class="form-group ">
												<label for="lastname" class="control-label col-lg-2">Batch
													Venue </label>
												<div class="col-lg-10">
													<form:input path="batch_venue" class=" form-control"
														id="lastname" type="text" />
												</div>
											</div>
											<div class="form-group ">
												<label for="username" class="control-label col-lg-2">Batch
													Type</label>
												<div class="col-lg-10">
													<form:select path="batch_type" class="form-control">
														<form:option value="DEVELOPMENT">Development</form:option>
														<form:option value="QE">QE</form:option>
													</form:select>
												</div>
											</div>
											<div class="form-group ">
												<label for="password" class="control-label col-lg-2">Total
													Candidates</label>
												<div class="col-lg-10">
													<form:input path="no_of_cand" class="form-control "
														id=" total_count" type="number" min="0" required="" />
												</div>
											</div>
											<div class="form-group ">
												<label for="username" class="control-label col-lg-2">City</label>
												<div class="col-lg-10">
													<form:select path="batch_city" class="form-control">
											...
											<div class="form-group ">
												<label for="password" class="control-label col-lg-2">Start
													Date</label>
												<div class="col-lg-10">
