...
<body class="fixed-left">
	...
	<%
		...
		List<Session> sessions = new SessionService().getSessionDaoObj().getSessionsByDate(new Date());
			...
			<div class="topbar-left">
				<div class="text-center">
					<a href="" class="logo"><img
						src="resources/images/Persistent_logo.png" size=1px alt="user-img"><span></span><span>TT
							Generator </span></a>
				</div>
			</div>
			...
			<div class="content">
				<div class="container">
						...
						<div class="col-sm-12">
							...
							<div class="pull-right">
								<button id="new_user"
									...
									data-toggle="modal" data-target="#myModal">Create New
									User</button>
											...
											<div class="panel panel-default">
												...
												<div class="panel-body">
													...
													<form:form modelAttribute="user"
														...
														method="get" action="create_user_1"
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6 col-lg-3">
							<div class="mini-stat clearfix bx-shadow">
								<form:form modelAttribute="user" id="download" method="get"
								...
								<div class="panel-body">
									<div class="inbox-widget nicescroll mx-box">
										...
										<%
											...
											List<Batch> batch_list = bs.getbatchlist();
										%>


										<%
											for (Batch vt : batch_list) {
										%>
										...
										<a href="#">
											<div class="inbox-item">
												...
												<%-- <p class="inbox-item-date"><% out.println(vt.getBatch_city()); %></p>
                                                     <p class="inbox-item-date"><% out.println(vt.getStart_date()); %></p> --%>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="inbox-widget nicescroll mx-box">
										...
										<%@page import="java.util.Date"%>
										<%
											com.bean.Session t1 = new Session();
											List<Session> sessions1 = new SessionService().getSessionDaoObj().getSessionsByDate(new Date());
										%>

										<%
											for (Session tr : sessions1) {
										%>
